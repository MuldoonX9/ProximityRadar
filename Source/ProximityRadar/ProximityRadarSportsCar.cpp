...
#include "ProximityRadarSportsCar.h"
#include "ProximityRadarSportsWheelFront.h"
#include "ProximityRadarSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AProximityRadarSportsCar::AProximityRadarSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UProximityRadarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UProximityRadarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UProximityRadarSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UProximityRadarSportsWheelRear::StaticClass();
