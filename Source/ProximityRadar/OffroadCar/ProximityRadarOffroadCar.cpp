...
#include "ProximityRadarOffroadCar.h"
#include "ProximityRadarOffroadWheelFront.h"
#include "ProximityRadarOffroadWheelRear.h"
...
AProximityRadarOffroadCar::AProximityRadarOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UProximityRadarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UProximityRadarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UProximityRadarOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UProximityRadarOffroadWheelRear::StaticClass();
